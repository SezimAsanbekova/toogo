...
export default function AdminLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        setError(data.error === "BLOCKED" ? t.errorBlocked : data.error === "INVALID_CREDENTIALS" ? t.errorInvalid : t.errorServer);
        return;
      }
          ...
          <div className="relative rounded-3xl overflow-hidden border border-white/10"
            ...
            <div className="p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Email */}
                <div>
                  <label className="block text-xs font-semibold mb-2 uppercase tracking-widest text-white/50">
                    {t.emailLabel}
                  </label>
                  <div className="relative">
                    <input
                      ...
                      required
                      autoComplete="email"
                      className="w-full px-4 py-3 pl-11 rounded-xl text-sm outline-none transition-all text-white placeholder-white/30"
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-11 pr-11 rounded-xl text-sm outline-none transition-all text-white placeholder-white/30"
                      style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.1)" }}
                      onFocus={(e) => e.target.style.borderColor = "#4ade80"}
                      onBlur={(e) => e.target.style.borderColor = "rgba(255,255,255,0.1)"}
                    />
